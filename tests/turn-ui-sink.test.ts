...
function mockSession(): Session {
  return {
    ...
    getLastWeightedTokens: mock(() => 100),
    getLastPressureMode: mock(() => "normal" as const),
    getLastRawPressureRatio: mock(() => 0),
    getDisplayContextSnapshot: mock(() => null),
    setDisplayContextSnapshot: mock(),
    ...
    recordReasoningEffortUsed: mock(),
    getLastReasoningEffortUsed: mock(() => null),
