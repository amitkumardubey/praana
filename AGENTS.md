...
src/
  ...
  ui/
    tui/           — OpenTUI + Solid terminal shell: Solid Prompt, transcript store/view, chrome/toast/spinner via shell-ui; login/logout wizards + model selector still imperative (Phase 3)
  skills/
